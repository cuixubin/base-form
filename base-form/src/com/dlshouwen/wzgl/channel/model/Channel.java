 ...
 */
package com.dlshouwen.wzgl.channel.model;
...
public class Channel {
     ...
     * 栏目排序
     */
    private Integer channel_seq = null;
    /**
     * 栏目父级栏目
     */
    private String channel_parent = null;
    /**
     * 栏目状态（1、启用 0、不启用）
     */
    private String channel_state = null;
    /**
     * 栏目创建人
     */
    private String channel_createUser = null;
    /**
     * 栏目创建时间
     */
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date channel_createDate = null;
    /**
     * 栏目更新时间
     */
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date channel_updateDate = null;
    /**
     * 栏目url
     */
    private String channel_url = null;
    /**
     * 栏目类型（1：网站栏目;2:首页栏目；3班级栏目 4社团栏目）
     */
     ...
     * 子集栏目
     */
    private List<Channel> children = null;
     ...
     * 栏目图片的ID
     */
    private String channel_picUrl = null;

    private String channel_edituser = null;
