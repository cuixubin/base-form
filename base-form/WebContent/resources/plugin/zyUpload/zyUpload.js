		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				</div>';
		            html += '			</div>';
					html += '			<div id="preview" class="upload_preview" style="overflow: visible;clear:both;line-height:0px;margin:0px;padding:0px;"></div>';
					html += '		</div>';
...
//		            html += '					<div class="upload_btn">开始上传</div>';
		            html += '				</div>';
		            html += '			</div>';
		            html += '			<div id="preview" class="upload_preview" style="overflow: visible;">';
				    html += '				<div class="add_upload">';
                                       html += '				<input name="albumId" id="albumId" value="" type="hidden"/>';
				    html += '					<a href="javaScript:void(0)" style="height:'+para.itemHeight+';width:'+para.itemWidth+';margin:0px;padding:0px;" title="点击添加文件" id="rapidAddImg" class="add_imgBox" href="javascript:void(0)">';
				    html += '						<div class="uploadImg" style="width:'+imgWidth+'px;margin:0px;padding:0px;" >';
				    html += '							<img class="upload_image" src="../../../resources/images/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
