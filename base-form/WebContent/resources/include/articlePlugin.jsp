...
<%-- grid --%>
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/plugin/grid/dlshouwen.grid.min.js"></script>
...
<%-- ueditor --%>
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/resources/plugin/ueditor1_4_3/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/resources/plugin/ueditor1_4_3/ueditor.all.min.js"></script>
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/resources/plugin/ueditor1_4_3/lang/zh-cn/zh-cn.js"></script>
<%-- video --%>
