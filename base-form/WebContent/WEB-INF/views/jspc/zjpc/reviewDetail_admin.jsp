        ...
        function submitStatus(expId,status){
                        ...
                        sw.openModal({
                            ...
                            callback: function () {
                                ...
                                var url = '${pageContext.request.contextPath }/jspc/zjpc/zjpc/ajaxReviewAdmin';
...
<body>
    ...
    <div class="main-container">
        <ul class="breadcrumb">
                ...
                <li class="active"><a href="${pageContext.request.contextPath }/jspc/zjpc/zjpc/admin"><i class="fa fa-legal"></i>专家评测(管理员)</a></li>
