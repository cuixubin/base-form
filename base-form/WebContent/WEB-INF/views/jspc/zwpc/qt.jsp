...
<div class="col-xs-12 column mybgstyle" id="section9"  style="margin-top:10px;">
    <div class="col-sm-12 itemTitle">
        <div class="col-sm-12 text-left">
            <a name="QT_INDEX"><span>其他</span></a>
        </div>
    </div>
    <div class="col-sm-12" >
        <div class="col-sm-12 itemDescription">技术职称信息</div>
        <div class="col-xs-12">
            <ul class="item-table-list-ul" id="QT_ID"></ul>
            ...
            <div  class="addItemButton">
                ...
                <table class="table  table-responsive item-table-list" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="text-right">
                            <button type="button" class="btn btn-primary  btn-md" onclick="addItem('${UVO.expreview.id}', 'QT')">添加</button>
                        </td>
                    </tr>
                </table>
                </c:if>
