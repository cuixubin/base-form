...
<html>
    <head>
        ...
        function addOneItem(){
            ...
            var url = '${pageContext.request.contextPath }/jspc/zwpc/zwpc/addEvalItem';
                ...
                <form:form cssClass="form-horizontal" id="evalItem_form" modelAttribute="evalItem" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-7 column" style="border-right:1px solid #ccc;">
                        <div class="form-group">
                            <label class="col-xs-2 control-label text-right" id ="starttime"><span class="mustfill">*</span>开始时间：</label>
                            <div class="col-xs-5">
                        ...
                        <div class="form-group">
                            <label class="col-xs-2 control-label text-right"><span class="mustfill">*</span>荣誉名称：</label>
                            <div class="col-xs-5">
                        ...
                        <div class="form-group">
                            <label class="col-xs-2 control-label text-right"><span class="mustfill">*</span>级别：</label>
                            <div class="col-xs-5">
                        ...
                        <div class="form-group">
                            <label class="col-xs-2 control-label text-right"><span class="mustfill">*</span>文件：</label>
                            <div class="col-xs-5">
