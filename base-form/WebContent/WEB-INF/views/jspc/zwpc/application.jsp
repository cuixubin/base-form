...
<html>
<head>
    <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } -评审申请</title>
    <base target="_self" />
    ...
    <style>
        ...
        /*.item-table-list-box{padding:20px;position:relative;cursor:pointer;border:1px solid #fff;background-color:#fff;}*/
    </style>
...
<body>
    ...
    <div class="main-container">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="${pageContext.request.contextPath }/jspc/zwpc/zwpc"><i class="fa fa-male"></i>自我评测</a></li>
            <li class="active"><a href="javascript:void(0);"><i class="fa fa-edit"></i>填写申请</a></li>
        </ul>
        ...
        <!---------------提交按钮 --------------->
                <div class="col-xs-12" style="margin-top:10px; height: 40px">
                    <div class=" text-center button">
                        <button  type="button" class="btn btn-primary btn-lg text-center" onclick="submitPs('${UVO.expreview.id}','notNumber')" id="buttonSend">提交评审</button>
                    </div>
                </div>
            </div>         
        </div>
