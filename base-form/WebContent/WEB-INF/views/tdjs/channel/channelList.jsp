...
<head>
    ...
    <script type="text/javascript">
        ...
        function addChannel() {
            ...
            var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/' + channelId + '/add';
            sw.showProcessBar();
            window.location.href = url;
        }
        //新建顶级栏目
        function addTopChannel() {
            var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/top/add';
            sw.showProcessBar();
            window.location.href = url;
        }
        //编辑栏目
        function editChannel() {
            ...
            var channelId = nodes[0].channel_id;
            var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/' + channelId + '/edit';
            sw.showProcessBar();
            window.location.href = url;
        }
        //删除栏目
        function deleteChannel() {
            ...
            var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/delete';
        ...
        function search_content() {
            var nodes = channelTree.getSelectedNodes();
            if (nodes == null || nodes.length == 0) {
                sw.toast('请选择要查看的栏目！', 'warning', 3000);
                return;
            }
            if (nodes.length > 1) {
                sw.toast('查看只能选择一个栏目。', 'warning', 3000);
                return;
            }
            var channelId = nodes[0].channel_id;
            var url = '${pageContext.request.contextPath }/tdjs/tdjsArticle/article?selChannelId=' + channelId;
            sw.showProcessBar();
            window.location.href = url;
        }
        ...
        $(function () {
            ...
            $('#search_content').bind('click', search_content);
        });
        //显示栏目信息
        var nowShowChannelId = '';
        function showDeptInfo(channelId) {
            nowShowChannelId = channelId;
            var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/info';
            var params = new Object();
            ...
            sw.ajaxSubmit(url, params, function (channel) {
                ...
                content += '	<tr><th>栏目创建人：</th><td>' + channel.creator_name + '</td><tr>';
                 content += '	<tr><th>团队名称：</th><td>' + channel.team_name + '</td><tr>';
            ...
            <div class="col-lg-5 col-md-5 col-sm-5">
                <div class="panel panel-default">
                    ...
                    <div class="panel-operation text-right">
                        <div class="btn-group">
                            <sw:button accesskey="A" id="add_channel" value="新建 (A)" cssClass="btn btn-xs btn-primary" limit="tdjs/tdjsChannel/channel/add" icon="plus" />
                            <sw:button accesskey="T" id="add_top_channel" value="新建顶级 (T)" cssClass="btn btn-xs btn-primary" limit="tdjs/tdjsChannel/channel/add" icon="plus" />
                            <sw:button accesskey="M" id="edit_channel" value="编辑 (M)" cssClass="btn btn-xs btn-primary" limit="tdjs/tdjsChannel/channel/-/edit" icon="edit" />
                            <sw:button accesskey="W" id="delete_channel" value="删除 (W)" cssClass="btn btn-xs btn-danger" limit="tdjs/tdjsChannel/channel/delete" icon="trash-o" />
                            <sw:button accesskey="S" id="search_content" value="查看 (S)" cssClass="btn btn-xs btn-primary" limit="tdjs/tdjsChannel/channel/searchContent" icon="search" />
                        </div>
                    </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-7">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="border-bottom:1px solid #ddd;">
                        ...
                        &nbsp;&nbsp;
                        当您点击某一个 <code>栏目</code> 时这里将显示该栏目的详细信息。</br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span> <code>温馨提示：</code>  一级栏目和顶级栏目为团队名称。</span>
                    </div>
