    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function editChannel() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/edit';
            ...
            function selectTeam() {
                ...
                var url = '${pageContext.request.contextPath }/core/team/selectOneTeam?teamId=' + team_id;
                sw.openModal({
                    id: 'selectTeam',
                    icon: 'group',
                    title: '选择团队',
                    ...
                    <form:form cssClass="form-horizontal" id="channelForm" modelAttribute="channel" method="post">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <sw:input path="team_name" cssClass="form-control" readonly="true" 
                                              valid="" validTitle="所属团队" validInfoArea="team_id_info_area" onclick="selectTeam('team_id', 'team_name');"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <sw:button accesskey="S" id="add_channel" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="tdjs/tdjsChannel/channel/-/edit" />
