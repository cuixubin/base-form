...
//			content += '&nbsp;&nbsp;';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-primary" title="编辑" limit="tdjs/tdjsPicture/picture/-/edit" onclick="editPictureSingle(\'' + record.picture_id + '\')"><i class="fa fa-edit"></i></button>';
                        content += '&nbsp;&nbsp;';
                        if (record.show == '1') {
                            content += '<button type="button" class="btn btn-xs btn-icon btn-warning" title="隐藏"  limit="tdjs/tdjsPicture/picture/hide" onclick="hidePictureSingle(\'' + record.picture_id + '\')"><i class="fa fa-minus"></i></button>';
                        } else {
                            content += '<button type="button" class="btn btn-xs btn-icon btn-success" title="显示" limit="tdjs/tdjsPicture/picture/show" onclick="showPictureSingle(\'' + record.picture_id + '\')"><i class="fa fa-check"></i></button>';
                        }
                        content += '&nbsp;&nbsp;';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-danger" title="删除" limit="tdjs/tdjsPicture/picture/delete" onclick="deletePictureSingle(\'' + record.picture_id + '\')"><i class="fa fa-trash-o"></i></button>';
                        return content;
                    }},
                {id: 'picture_name', title: '图片名称', type: 'string', columnClass: 'text-center', hideType: 'xs|sm', fastQuery: true, fastQueryType: 'lk'},
                ...
                {id: 'team_name', title: '所属团队', type: 'string', columnClass: 'text-center', hideType: 'xs|sm|md|lg', fastQuery: true, fastQueryType: 'lk'},
            ...
            var gridOption = {
                loadURL: '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/list',
                ...
                onGridComplete: function (value, record, column, grid, dataNo, columnNo, cell, row, extraCell, e) {
                    var urls = '';
                    urls += 'tdjs/tdjsPicture/picture/-/edit,';
                    urls += 'tdjs/tdjsPicture/picture/show,';
                    urls += 'tdjs/tdjsPicture/picture/hide,';
                    urls += 'tdjs/tdjsPicture/picture/delete';
            ...
            //跳转添加
            function addPicture() {
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/add';
                sw.showProcessBar();
            ...
            function showPicture() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/show';
            ...
            function hidePicture() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/hide';
                var params = new Object();
                params.pictureIds = pictureIds;
                sw.showProcessBar();
                sw.ajaxSubmitRefreshGrid(url, params, grid);
            ...
            function deletePicture() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/delete';
                var params = new Object();
                params.pictureIds = pictureIds;
                sw.showProcessBar();
                sw.ajaxSubmitRefreshGrid(url, params, grid);
            ...
            function editPicture() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/' + pictureId + '/edit';
                sw.showProcessBar();
                window.location.href = url;
            }
            //编辑跳转
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-file-photo-o"></i>大图管理</a></li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-bell"></i>大图管理列表</div>
                <div class="panel-operation">
                    <div class="btn-group">
                        <sw:button accesskey="A" id="add_picture" value="新建 (A)" cssClass="btn btn-primary" limit="tdjs/tdjsPicture/picture/add" icon="plus" />
                        <sw:button accesskey="M" id="edit_picture" value="编辑 (M)" cssClass="btn btn-primary" limit="tdjs/tdjsPicture/picture/-/edit"  icon="edit" />
                        <sw:button accesskey="O" id="show_picture" value="显示 (O)" cssClass="btn btn-success" limit="tdjs/tdjsPicture/picture/show" icon="check" />
                        <sw:button accesskey="C" id="hide_picture" value="隐藏 (C)" cssClass="btn btn-warning" limit="tdjs/tdjsPicture/picture/hide" icon="minus" />
                        <sw:button accesskey="W" id="delete_picture" value="删除 (W)" cssClass="btn btn-danger" limit="tdjs/tdjsPicture/picture/delete" icon="trash-o" />
                    </div>
                </div>
