...
<html>
    <head>
        <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增图片</title>
        <base target="_self" />
        ...
        <script type="text/javascript">
            ...
            function addPicture() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/ajaxAdd';
            ...
            function initData() {
                $("#picImg").html("<img  src=" + contextPath + "/resources/images/no_picture.jpg" + " alt=''  height='150px' width='200px' style='margin-top:5px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='scale');-moz-background-size:100% 100%;background-size:100% 100%;'/>");
            }
//      验证图片  
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-group"></i>新增图片</a></li>
            </ul>
            <form:form id="pictureForm" modelAttribute="picture" method="post" contentType="multipart/form-data ">
                <div class="panel panel-default">
                    <div class="panel-heading"><i class="fa fa-plus"></i>新增图片</div>
                    <div class="panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"><p class="help-block" id="path_info_area"></p></div>
                            </div>        

                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <sw:button accesskey="S" id="add_picture" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="tdjs/tdjsPicture/picture/add" />
