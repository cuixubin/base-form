    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>打开相册</a></li>
            </ul>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="text-center">
                            <sw:button accesskey="S" id="add_picture" cssClass="btn btn-success" value="上传 (S)" icon="save" limit="tdjs/tdjsAlbum/album/batchAdd" onclick="addPicture('${album.album_id}')"/>
                            <sw:button accesskey="C" id="sort_picture" cssClass="btn btn-success" value="确认排序 (C)" icon="sort" limit="tdjs/tdjsAlbum/album/updatePicOrder" onclick="savePicOrder()"/>
                        </div>
                    </div>
                </div>
