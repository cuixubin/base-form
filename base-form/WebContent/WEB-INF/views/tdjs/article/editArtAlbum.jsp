...
<html>
    <head>
        <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 编辑文章相册</title>
        <base target="_self" />
        ...
        <script type="text/javascript">
            ...
            function editAlbum() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsArticle/article/editAlbum';
            ...
            $(function () {
                ...
                if ('${album.album_coverpath}' != '') {
                    $("#picImg").html("<img  src=${applicationScope.__SYSTEM_ATTRIBUTE__.source_webapp_file_postion.content }${album.album_coverpath}" + " alt=''  height='150px' width='200px'  style='filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='scale');-moz-background-size:100% 100%;background-size:100% 100%;'/>");
                } else {
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-group"></i>编辑相册</a></li>
            </ul>
                    ...
                    <form:form cssClass="form-horizontal" id="albumForm" modelAttribute="album" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <sw:button accesskey="S" id="add_album" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="tdjs/tdjsArticle/article/add" />
