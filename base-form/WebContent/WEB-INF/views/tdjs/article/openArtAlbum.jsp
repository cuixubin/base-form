...
<html>
    <head>
        <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 打开文章相册</title>
        <base target="_self" />
        ...
        <script>
            ...
            function addPicture(album_id) {
                if (album_id !== null && 　album_id !== "") {
                    var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/' + album_id + '/batchAdd';
                    sw.openModal({
                        id: 'albumId',
                        icon: 'bell',
                        title: "添加",
            ...
            function editPic(pictureId, albumId, albCoverPath) {
                ...
                if (pictureId != null && pictureId != "") {
                    var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/' + pictureId + '/editAlbPic';
                    sw.openModal({
                        id: 'editAlbPic',
                        icon: 'eye',
                        title: '预览',
                        ...
                        callback: function () {
                            ...
                            if ((this.id).indexOf("coverModel") != -1) {
                                var url = '${pageContext.request.contextPath }/tdjs/tdjsAlbum/album/updateAlbCover';
                                $.ajax({
                                    type: "post",
                                    url: url,
            ...
            function savePicOrder() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsPicture/picture/updatePicOrder';
                $.ajax({
                    type: "post",
                    url: url,
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath }/tdjs/tdjsArticle/article"><i class="fa fa-file-o"></i>文章管理</a></li>
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-group"></i>打开文章相册</a></li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-plus"></i>打开文章相册</div>
                    ...
                    <div class="row" >
                                ...
                                <c:forEach items="${pic}" var="pic">
                                    <li class="col-lg-3 col-sm-4 col-xs-6" name="theli" id="${pic.picture_id}">
                                        <div class="out_Div" >
                                            ...
                                            <a href="#" style="text-align:center;width:190px;height:100px;display:block;background-color:#ececec;">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center">
                                <sw:button accesskey="S" id="add_picture" cssClass="btn btn-success" value="上传 (S)" icon="save" limit="tdjs/tdjsAlbum/picture/batchAdd" onclick="addPicture('${album.album_id}')"/>
                                <sw:button accesskey="C" id="sort_picture" cssClass="btn btn-success" value="确认排序 (C)" icon="sort" limit="tdjs/tdjsAlbum/picture/updatePicOrder" onclick="savePicOrder()"/>
                            </div>
                        </div>
                    </div>
