                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <sw:input path="channel_name" disabled="true" cssClass="form-control" readonly="true" placeholder="请选择所属栏目"
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <sw:button accesskey="S" id="edit_article" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="tdjs/tdjsArticle/article/-/edit" />
