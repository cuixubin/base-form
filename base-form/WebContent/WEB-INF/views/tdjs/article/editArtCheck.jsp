...
<html>
    <head>
        <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 审核文章</title>
        <base target="_self" />
        ...
        <script type="text/javascript">
            ...
            function editArticle() {
                ...
                var url = '${pageContext.request.contextPath }/tdjs/tdjsArticle/article/edit';
            ...
            function selectChannel() {
                var url = '${pageContext.request.contextPath }/tdjs/tdjsChannel/channel/select/radio';
                sw.openModal({
                    id: 'selectChannel',
                    icon: 'navicon',
                    title: '选择栏目',
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <sw:button accesskey="S" id="edit_article" cssClass="btn btn-success" value="通过 (S)" icon="save" limit="tdjs/tdjsArticle/article/open" />
