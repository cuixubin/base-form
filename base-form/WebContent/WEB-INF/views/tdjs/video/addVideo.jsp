        ...
        <script type="text/javascript">
            ...
            function uploadVideo() {
                var up = $('#upload').Huploadify({
                    ...
                    uploader: '${pageContext.request.contextPath }/tdjs/tdjsVideo/video/upload',
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li  class="active"><a href="javascript:void(0);"><i class="fa fa-group"></i>新增视频</a></li>
                    ...
                    <form:form cssClass="form-horizontal" id="videoForm" modelAttribute="video" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <sw:button accesskey="S" id="add_video" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="tdjs/tdjsVideo/video/add" />
