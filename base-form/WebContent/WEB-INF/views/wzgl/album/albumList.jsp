        ...
        <script type="text/javascript">
            var gridColumns = [
                {id: 'operation', title: '操作', columnClass: 'text-center', columnStyle: 'width:150px;', hideType: 'xs', extra: false, 'export': false, print: false, advanceQuery: false, resolution: function (value, record, column, grid, dataNo, columnNo) {
                        var content = '';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-primary" title="编辑" limit="wzgl/album/album/-/edit" onclick="editAlbumSingle(\'' + record.album_id + '\')"><i class="fa fa-edit"></i></button>';
                        content += '&nbsp;&nbsp;';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-danger" title="删除" limit="wzgl/album/album/delete" onclick="deleteAlbumSingle(\'' + record.album_id + '\')"><i class="fa fa-trash-o"></i></button>';
                        content += '&nbsp;&nbsp;';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-default" title="打开相册" limit="wzgl/album/album/-/openAlbum" onclick="openAlbumSingle(\'' + record.album_id + '\')"><i class="fa fa-eye"></i></button>';
                        return content;
                    }},
                {id: 'album_name', title: '相册名称', type: 'string', hideType: '', fastQuery: true, fastQueryType: 'lk'},
            ...
            var gridOption = {
                loadURL: '${pageContext.request.contextPath }/wzgl/album/album/list',
                ...
                onGridComplete: function (value, record, column, grid, dataNo, columnNo, cell, row, extraCell, e) {
                    var urls = '';
                    urls += 'wzgl/album/album/-/edit,';
                    urls += 'wzgl/album/album/delete';
            ...
            function deleteAlbum() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/album/album/delete';
            ...
            function editAlbum() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/album/album/' + albumId + '/edit';
                sw.showProcessBar();
                window.location.href = url;
            }
            //编辑跳转
            ...
            function openAlbumSingle(album_id) {
                var url = '${pageContext.request.contextPath }/wzgl/album/album/' + album_id + '/openAlbum';
                sw.showProcessBar();
                window.location.href = url;
            }
            //打开相册跳转
            function openAlbum() {
                ...
                var albumId = recordObj[0].album_id;
                var url = '${pageContext.request.contextPath }/wzgl/album/album/' + albumId + '/openAlbum';
                sw.showProcessBar();
                window.location.href = url;
            }
            //初始化绑定方法
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"><i class="fa fa-bell"></i>相册管理</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-operation">
                    <div class="btn-group">
                        <sw:button accesskey="A" id="add_album" value="新建 (A)" cssClass="btn btn-primary" limit="wzgl/album/album/add" icon="plus" />
                        <sw:button accesskey="M" id="edit_album" value="编辑 (M)" cssClass="btn btn-primary" limit="wzgl/album/album/-/edit" icon="edit" />
                        <sw:button accesskey="O" id="open_album" value="打开相册 (O)" cssClass="btn btn-primary" limit="wzgl/album/album/-/preview" icon="file-image-o" />
                        <sw:button accesskey="W" id="delete_album" value="删除 (W)" cssClass="btn btn-danger" limit="wzgl/album/album/delete" icon="trash-o" />
                    </div>
                </div>
