    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function editAlbum() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/album/album/edit';
            ...
            $(function () {
                ...
                if ('${album.album_coverpath}' != '') {
                    $("#picImg").html("<img  src=${applicationScope.__SYSTEM_ATTRIBUTE__.source_webapp_file_postion.content }${album.album_coverpath}" + " alt=''  style='height: 180px;max-width: 280px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='scale');'/>");
                } else {
                    $("#picImg").html("<img  src=${pageContext.request.contextPath }/resources/images/no_picture.jpg" + " alt=''   style='height: 180px;max-width: 280px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='scale');'/>");
                }
            });
        </script>
    </head>
                ...
                <div class="panel-body">
                    <form:form cssClass="form-horizontal" id="albumForm" modelAttribute="album" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div id="picImg" style="border:1px solid #ccc;padding:10px;display:inline-block;    width: 300px; height: 200px;text-align: center; overflow: hidden;"> </div>
                            </div>
                        </div> 
                        <div class="form-group">
