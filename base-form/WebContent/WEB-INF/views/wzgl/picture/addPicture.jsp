    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function addPicture() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/picture/picture/ajaxAdd';
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>添加图片</a></li>
            </ul>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <sw:button accesskey="S" id="add_picture" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="wzgl/picture/picture/add" />
