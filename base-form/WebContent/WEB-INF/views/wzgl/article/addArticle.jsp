    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectChannel() {
                var url = '${pageContext.request.contextPath }/wzgl/channel/channel/select/radio';
                sw.openModal({
                    id: 'selectChannel',
                    icon: 'navicon',
                    title: '选择栏目',
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"><i class="fa fa-bell"></i>文章管理</a></li>
                <li><a href="${pageContext.request.contextPath }/wzgl/article/article"><i class="fa fa-bell"></i>文章管理</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label text-right">文章相册：</label>
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <div id="uploader">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <sw:button accesskey="S" id="add_article" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="wzgl/article/article/add" />
        ...
        <script>
            var uploadUrl = "${pageContext.request.contextPath }/wzgl/picture/picture/${article.article_id}/ajaxMultipartAdd?flag=article";
        </script>  
