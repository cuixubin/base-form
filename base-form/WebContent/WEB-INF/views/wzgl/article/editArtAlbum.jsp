    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function editAlbum() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/article/article/editAlbum';
                    ...
                    <form:form cssClass="form-horizontal" id="albumForm" modelAttribute="album" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <sw:button accesskey="S" id="add_album" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="wzgl/album/album/edit" />
