    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function addChannel() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/channel/channel/add';
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增栏目</a></li>
            </ul>
                    ...
                    <form:form id="channelForm" cssClass="form-horizontal" modelAttribute="channel" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <sw:button accesskey="S" id="add_channel" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="wzgl/channel/channel/add" />
