...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 模板管理</title>
	<base target="_self" />
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/wzgl/template/file.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/wzgl/template/handlers.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/wzgl/template/upload.js"></script>
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-file-text-o"></i>模板文件管理</a></li>
		</ul>
		<div class="row">
			<div class="col-lg-7 col-md-7">
				<div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-file-o"></i>模板文件管理</div>
			...
			<div class="col-lg-5 col-md-5">
				<div class="panel panel-default">
					...
					<form id="form" action="/template/upload" method="post" enctype="multipart/form-data">
