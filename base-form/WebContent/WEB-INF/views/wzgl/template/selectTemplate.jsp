...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 选择文件</title>
	<base target="_self" />
	...
	var uploadPicPattern = '${uploadFilePattern}';
	var uploadPicMaxSize = '${uploadFileMaxSize}';
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/core/server/file/file.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/core/server/file/handlers.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/core/server/file/upload.min.js"></script>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/css/core/server/file/layout.min.css" />
</head>
<body>
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-file-o"></i>文件服务器</div>
					<div class="panel-operation">
						...
						&nbsp;&nbsp;|&nbsp;&nbsp;
						<div class="btn-group">
							<sw:button accesskey="X" value="选择 (X)" cssClass="btn btn-success" icon="save" onclick="selectFile();" />
							<sw:button accesskey="Z" value="清空 (Z)" cssClass="btn btn-danger" icon="trash-o" onclick="clearFile();" />
						</div>
					</div>
					<div class="panel-operation" style="padding:8px;">
						<input type="text" id="path_container" name="path_container" class="form-control" readonly="readonly" value="\" />
					</div>
					<div class="panel-body" id="show_files_container" style="padding:8px;min-height:320px;padding-bottom:0;"></div>
				</div>
			</div>
			<div class="col-lg-6 col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-upload"></i>文件上传</div>
					<div class="panel-operation">
					...
					<form id="form" action="/file/upload" method="post" enctype="multipart/form-data">
