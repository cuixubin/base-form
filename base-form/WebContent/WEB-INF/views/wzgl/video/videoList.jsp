        ...
        <script type="text/javascript">
            var gridColumns = [
                {id: 'operation', title: '操作', columnClass: 'text-center', columnStyle: 'width:150px;', hideType: 'xs', extra: false, 'export': false, print: false, advanceQuery: false, resolution: function (value, record, column, grid, dataNo, columnNo) {
                        ...
                        content += '&nbsp;&nbsp;';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-primary" title="编辑" limit="wzgl/video/video/-/edit/-/edit" onclick="editVideoSingle(\'' + record.vd_id + '\')"><i class="fa fa-edit"></i></button>';
                        content += '&nbsp;&nbsp;';
                        if (record.vd_isdisplay == '1') {
                            content += '<button type="button" class="btn btn-xs btn-icon btn-warning" title="禁用" limit="wzgl/video/video/close" onclick="closeVideoSingle(\'' + record.vd_id + '\')"><i class="fa fa-minus"></i></button>';
                        } else {
                            content += '<button type="button" class="btn btn-xs btn-icon btn-success" title="启用" limit="wzgl/video/video/open" onclick="openVideoSingle(\'' + record.vd_id + '\')"><i class="fa fa-check"></i></button>';
                        }
                        content += '&nbsp;&nbsp;';
                        content += '<button type="button" class="btn btn-xs btn-icon btn-danger" title="删除" limit="wzgl/video/video/-/edit/delete" onclick="deleteVideoSingle(\'' + record.vd_id + '\')"><i class="fa fa-trash-o"></i></button>';
                        return content;
                    }},
                {id: 'vd_name', title: '视频名称', type: 'string', hideType: '', fastQuery: true, fastQueryType: 'lk'},
                {id: 'vd_time', title: '视频类型说明', columnClass: 'text-center', hideType: '', fastQuery: true, fastQueryType: 'lk'},
            ...
            var gridOption = {
                loadURL: '${pageContext.request.contextPath }/wzgl/video/video/list',
                ...
                onGridComplete: function (value, record, column, grid, dataNo, columnNo, cell, row, extraCell, e) {
                    var urls = '';
                    urls += 'wzgl/video/video/-/edit,';
                    urls += 'wzgl/video/video/open,';
                    urls += 'wzgl/video/video/close,';
                    urls += 'wzgl/video/video/delete';
            ...
            function openVideo() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/video/video/open';
            ...
            function closeVideo() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/video/video/close';
                var params = new Object();
                params.videoIds = videoIds;
                sw.showProcessBar();
                sw.ajaxSubmitRefreshGrid(url, params, grid);
            ...
            function deleteVideo() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/video/video/delete';
                var params = new Object();
                params.videoIds = videoIds;
                sw.showProcessBar();
                sw.ajaxSubmitRefreshGrid(url, params, grid);
            ...
            function editVideo() {
                ...
                var url = '${pageContext.request.contextPath }/wzgl/video/video/' + videoId + '/edit';
                sw.showProcessBar();
                window.location.href = url;
            }
            //编辑跳转
...
//                    return;
//                }
                var url = '${pageContext.request.contextPath }/wzgl/video/video/preview?videoId='+vd_id;
                sw.openModal({
                    id: 'videoPreview',
                    icon: 'video',
                    title: '视频预览',
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"><i class="fa fa-book"></i>视频管理</a></li>
