...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增公告</title>
	<base target="_self" />
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增公告</a></li>
		</ul>
		<form:form id="announcementForm" modelAttribute="announcement" method="post">
			<div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-plus"></i>新增公告</div>
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<sw:button accesskey="S" id="add_announcement" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/announcement/announcement/add" />
