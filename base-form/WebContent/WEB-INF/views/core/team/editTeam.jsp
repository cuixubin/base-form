...
<html>
    <head>
        <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 编辑团队</title>
        <base target="_self" />
        ...
        <script type="text/javascript">
            ...
            function initPic(){
                var ipath = '${team.team_path}';
                if(null == ipath || '' == ipath) {
                    $("#picImg").html('<img src="${pageContext.request.contextPath }/resources/images/no_picture.jpg" height=\'150px\' width=\'200px\' style=\'margin-top:5px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=\'scale\');-moz-background-size:100% 100%;background-size:100% 100%;\' alt="团队照片">');
                }else {
                    $("#picImg").html('<img src="${applicationScope.__SYSTEM_ATTRIBUTE__.source_webapp_file_postion.content }'+ipath+'" height=\'150px\' width=\'200px\' style=\'margin-top:5px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=\'scale\');-moz-background-size:100% 100%;background-size:100% 100%;\' alt="团队照片">');
                }
            }
            //返回
            function goBack() {
            ...
            function editTeam() {
                ...
                if (!confirm('确定编辑此团队吗？')) {
                 ...
                 var url = '${pageContext.request.contextPath }/core/team/edit';
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-edit"></i>编辑团队</a></li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-edit"></i>编辑团队</div>
                <div class="panel-body">
                    <form:form cssClass="form-horizontal" id="teamForm" modelAttribute="team" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <sw:input path="principal_phone" cssClass="form-control" placeholder="请输入负责人电话" valid="l-l20" validTitle="负责人电话" validInfoArea="principal_phone_info_area" />
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <sw:button accesskey="S" id="edit_team" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/team/-/edit" />
