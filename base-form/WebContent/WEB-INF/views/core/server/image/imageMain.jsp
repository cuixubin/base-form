...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 图片服务器</title>
	<base target="_self" />
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li><a href="javascript:void(0);"><i class="fa fa-folder-o"></i>基础管理</a></li>
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-image"></i>图片服务器</a></li>
		</ul>
		<div class="row">
