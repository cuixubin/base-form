...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 转发邮件</title>
	<base target="_self" />
...
<body>
	<form action="/mail/draft/save" id="mailForm" enctype="multipart/form-data">
			...
			<div class="panel-body">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="hidden" id="receivers" name="receivers" value="${mail.receiver }" />
					...
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="text" id="title" name="title" class="form-control" placeholder="请输入" valid="l-l200" value="转发：${transmitMail.title }" />
						</div>
					</div>
					<div class="form-group">
		...
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-file-o"></i>邮件内容</div>
			<div class="panel-body" style="padding:0px;">
				<textarea id="content" name="content">
					<br />----邮件原件----<br />
					发件人：${transmitMail.sender_name }<br />
					发送时间：${transmitMail.send_time }<br />
					收件人：${transmitMail.receiver_name }<br />
					主题：${transmitMail.title }<br />
					${transmitMail.content }
				</textarea>
			</div>
		</div>
	</form>
