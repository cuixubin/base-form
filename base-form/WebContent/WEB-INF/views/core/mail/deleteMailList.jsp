...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 已删除邮件</title>
	<base target="_self" />
	...
	var gridColumns = [
		{id:'operation', title:'操作', columnClass:'text-center', columnStyle:'width:140px;', hideType:'xs', extra:false, 'export':false, print:false, advanceQuery:false, resolution:function(value, record, column, grid, dataNo, columnNo){
			...
			content += '&nbsp;&nbsp;';
			content += '<button type="button" class="btn btn-xs btn-icon btn-danger" title="删除" onclick="deleteMailSingle(\''+record.mail_id+'\')"><i class="fa fa-trash-o"></i></button>';
			return content;
		}},
		{id:'title', title:'邮件主题', type:'string', columnClass:'text-center', hideType:'', fastQuery:true, fastQueryType:'lk' },
		{id:'delete_from', title:'删除来源', type:'string', codeTable:code_table_info['mail_delete_from'], columnClass:'text-center', hideType:'xs|sm', fastQuery:true, fastQueryType:'eq' },
	...
	var gridOption={
		loadURL : '${pageContext.request.contextPath }/core/mail/delete/list',
		functionCode : 'CORE_MAIL_DELETE',
		check:true,
		exportFileName : '已删除邮件列表',
		columns : gridColumns,
	...
	function deleteMail(){
		...
		url = '${pageContext.request.contextPath }/core/mail/delete';
	...
	//删除操作
	function deleteMailSingle(mailId){
	...
	$(function(){
		...
		$('#delete_mail').bind('click', deleteMail);
	});
	</script>
</head>
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-trash-o"></i>已删除邮件</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-trash-o"></i>已删除邮件</div>
			<div class="panel-operation">
				<div class="btn-group">
					...
					<sw:button accesskey="W" id="delete_mail" value="删除 (W)" cssClass="btn btn-danger" icon="trash-o" />
				</div>
			</div>
