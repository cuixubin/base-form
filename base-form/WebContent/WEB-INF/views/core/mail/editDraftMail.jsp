...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 编辑草稿</title>
	<base target="_self" />
...
<body>
	<form action="/mail/draft/save" styleId="validForm" enctype="multipart/form-data">
			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="text" id="title" name="title" class="form-control" placeholder="请输入主题" valid="l-l200" value="${mail.title }" />
						</div>
					</div>
					<div class="form-group">
