...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 答复邮件</title>
	<base target="_self" />
	...
	function addDraftMessage(){
		var url = '${pageContext.request.contextPath }/mail/mail/draft/save';
	...
	function sendMessage(){
		...
		var url = '${pageContext.request.contextPath }/mail/mail/send';
		var params = sw.getFormParams(document.forms[0]);
		params.content = ue.getContent();
		sw.showProcessBar();
		sw.ajaxSubmit(url, params, function(data){
			...
			<div class="panel-body">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="hidden" id="receivers" name="receivers" value="${replyMail.sender }" />
							<div class="input-group">
								<input type="text" id="receiver_names" name="receiver_names" class="form-control" placeholder="请输入收件人" 
									valid="r" readonly="readonly" value="${replyMail.receiver_name }" ondblclick="selectUsers();" />
					...
					<div class="form-group">
						...
						<div class="col-xs-10">
							<input type="text" id="title" name="title" class="form-control" placeholder="请输入" valid="l-l200" value="答复：${replyMail.title }" />
						</div>
					</div>
					<div class="form-group">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="padding:0px;">
				<textarea id="content" name="content">
					<br />----邮件原件----<br />
					发件人：${replyMail.sender_name }<br />
					发送时间：${replyMail.send_time }<br />
					收件人：${replyMail.receiver_name }<br />
					主题：${replyMail.title }<br />
					${replyMail.content }
				</textarea>
			</div>
		</div>
