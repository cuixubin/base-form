...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 编辑参数</title>
	<base target="_self" />
	...
	function editAttr(){
		...
		var url = '${pageContext.request.contextPath }/core/system/attr/edit';
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-edit"></i>编辑参数</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-edit"></i>编辑参数</div>
				...
				<form:form cssClass="form-horizontal" id="attrForm" modelAttribute="attr" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<sw:input path="attr_code" cssClass="form-control" placeholder="请输入参数编号" valid="r|english_number|l-l80" 
								validTitle="参数编号" validInfoArea="attr_code_info_area" validUnique="ATTR_CODE_UNIQUE_FOR_EDIT|attr_id" />
						</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="edit_attr" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/attr/-/edit" />
