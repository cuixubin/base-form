...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增系统</title>
	<base target="_self" />
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增系统</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-plus"></i>新增系统</div>
				...
				<form:form cssClass="form-horizontal" id="systemForm" modelAttribute="system" method="post">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<sw:input path="system_code" cssClass="form-control" placeholder="请输入系统编号" valid="r|english_number|l-l20" 
								validTitle="系统编号" validInfoArea="system_code_info_area" validUnique="SYSTEM_CODE_UNIQUE_FOR_ADD" />
						</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="add_system" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/system/add" />
