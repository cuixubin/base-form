...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增码表</title>
	<base target="_self" />
	...
	function addCodeTable(){
		...
		var url = '${pageContext.request.contextPath }/core/system/code_table/code_table/add';
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增码表</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-plus"></i>新增码表</div>
				...
				<form:form cssClass="form-horizontal" id="codeTableForm" modelAttribute="codeTable" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<sw:input path="c_key" cssClass="form-control" placeholder="请输入码表编号" valid="r|l-l20" 
								validTitle="码表编号" validInfoArea="c_key_info_area" validUnique="CODE_TABLE_C_KEY_UNIQUE_FOR_ADD|c_type" />
						</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="add_code_table" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/code_table/-/code_table/add" />
