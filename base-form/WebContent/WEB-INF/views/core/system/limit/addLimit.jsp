...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增功能</title>
	<base target="_self" />
	...
	function addLimit(){
		...
		var url = '${pageContext.request.contextPath }/core/system/limit/add';
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增功能</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-plus"></i>新增功能</div>
				...
				<form:form cssClass="form-horizontal" id="limitForm" modelAttribute="limit" method="post">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="add_limit" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/limit/add" />
