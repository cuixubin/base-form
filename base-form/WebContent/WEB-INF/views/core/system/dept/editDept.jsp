...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 编辑部门</title>
	<base target="_self" />
	...
	function editDept(){
		...
		var url = '${pageContext.request.contextPath }/core/system/dept/edit';
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-edit"></i>编辑部门</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-edit"></i>编辑部门</div>
				...
				<form:form cssClass="form-horizontal" id="deptForm" modelAttribute="dept" method="post">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="edit_dept" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/dept/-/edit" />
