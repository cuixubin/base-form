...
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 设置用户参数</title>
	<base target="_self" />
	...
	function setUserAttr(){
		...
		var url = '${pageContext.request.contextPath }/core/system/user/set_user_attr';
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:;"><i class="fa fa-gears"></i>为 <span class="text-primary">${user.user_name }</span> 设置参数</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-gears"></i>设置用户参数</div>
