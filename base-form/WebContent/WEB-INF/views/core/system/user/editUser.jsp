...
<html>
    <head>
        <title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 编辑用户</title>
        <base target="_self" />
        ...
        <script type="text/javascript">
            ...
            function editUser() {
                ...
                var url = '${pageContext.request.contextPath }/core/system/user/edit';
...
//                    $("#picImg").html('<img src="${pageContext.request.contextPath }/downloadImage.jsp?path=${user.imgpath}" alt="个人照片">');
                    $("#picImg").html('<img src="${applicationScope.__SYSTEM_ATTRIBUTE__.source_webapp_file_postion.content }${user.imgpath}" alt="个人照片1">');
                }
            });
            //验证图片  
            ...
            */
            ...
            //选择机构
            function selectDept() {
                var url = '${pageContext.request.contextPath }/core/system/dept/select/radio?deptId=' + deptId;
                sw.openModal({
                    id: 'selectDept',
                    icon: 'building',
                    title: '选择机构',
            ...
            //选择团队
            function selectTeam() {
                var url = '${pageContext.request.contextPath }/core/team/select/radio?teamId=' + teamId;
                sw.openModal({
                    id: 'selectTeam',
                    icon: 'group',
                    title: '选择团队',
    ...
    <body>
        ...
        <div class="main-container">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="javascript:void(0);"><i class="fa fa-edit"></i>编辑用户</a></li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-edit"></i>编辑用户</div>
                    ...
                    <div class="form-group"> 
                        <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                            <sw:input path="graduateSchool" cssClass="form-control" placeholder="请输入毕业院校信息" valid="" validInfoArea="grdSchool_info_area" />
                                    </div>
                                    <div class="col-sm-3"></div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                            <sw:input path="phone" cssClass="form-control" placeholder="请输入联系电话" valid="r|phone|l-l30" validTitle="联系电话" validInfoArea="phone_info_area" />
                                    </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                            <sw:input path="email" cssClass="form-control" placeholder="请输入E-mail" valid="r|email|l-l30" validTitle="E-mail" validInfoArea="email_info_area" />
                                    </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                            <sw:textarea path="remark" cssClass="form-control" placeholder="请输入备注" valid="l-200" validInfoArea="remark_info_area" />
                                    </div>
                                    <div class="col-sm-3"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                        <sw:button accesskey="S" id="edit_user" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/user/add" />
