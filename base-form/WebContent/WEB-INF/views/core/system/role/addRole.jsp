...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增角色</title>
	<base target="_self" />
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增角色</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-plus"></i>新增角色</div>
				...
				<form:form cssClass="form-horizontal" id="roleForm" modelAttribute="role" method="post">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="add_role" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/system/role/add" />
