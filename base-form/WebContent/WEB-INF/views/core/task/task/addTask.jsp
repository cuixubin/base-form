...
<html>
<head>
	<title>${applicationScope.__SYSTEM_ATTRIBUTE__.page_title.content } - 新增任务</title>
	<base target="_self" />
	...
	function insertTaskAttr(type, id){
		...
		if(type=='before'){
			...
			jQuery('#attr_table').append(content);
			resetSequence();
		}
	}
	//重排编号
...
<body>
	...
	<div class="main-container">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="javascript:void(0);"><i class="fa fa-plus"></i>新增任务</a></li>
		</ul>
		<div class="panel panel-default">
			<div class="panel-heading"><i class="fa fa-plus"></i>新增任务</div>
				...
				<form:form cssClass="form-horizontal" id="taskForm" modelAttribute="task" method="post">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<sw:button accesskey="S" id="add_task" cssClass="btn btn-success" value="保存 (S)" icon="save" limit="core/task/task/add" />
		...
		<div class="panel panel-default">
			...
			<div class="panel-body" id="task_attr_container" style="padding:0px;">
				<table id="attr_table" class="table table-bordered table-hover table-responsive">
					<tr>
